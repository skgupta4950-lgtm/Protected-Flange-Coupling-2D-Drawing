...
A["⚙️ Required Power & Speed"] --> B["Calculate Torque"]
B --> C["Determine Shaft Diameter"]
C --> D["Design Hub"]
D --> E["Design Key"]
E --> F["Design Flange"]
F --> G["Design Bolts"]
G --> H["Check Stresses"]
H --> I["Prepare CAD Drawing"]
I --> J["Final Design"]
...
A["Rotating Bolt Head"] --> B["Protective Projection"]
B --> C["Reduced Accidental Contact"]
C --> D["Improved Operator Safety"]
...
A["📋 Study Machine Design Requirements"]
--> B["📐 Select Basic Dimensions"]

B --> C["🖥️ Create Shaft & Hub Profile"]

C --> D["🔩 Create Flange Geometry"]

D --> E["🔑 Add Keyway"]

E --> F["🔧 Add Bolt & Nut Details"]

F --> G["✂️ Create Sectional Representation"]

G --> H["📏 Add Dimensions"]

H --> I["📝 Add Annotations & Centerlines"]

I --> J["🔍 Check Drawing"]

J --> K["✅ Final 2D CAD Drawing"]
